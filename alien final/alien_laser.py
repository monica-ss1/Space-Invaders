...
class Sound:
    def __init__(self):
        ...
        self.pickup = pg.mixer.Sound('last 2/sounds/pickup.wav')
        self.gameover = pg.mixer.Sound('last 2/sounds/gameover2.mp3')
        self.faster = pg.mixer.Sound('last 2/sounds/Running.mp3')
        ...
        pg.mixer.music.load('last 2/sounds/Megalovonia.mp3')
